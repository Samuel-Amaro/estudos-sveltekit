...
//por padrão o svelte remove as barras finais de uma request, mas podemos especificar a trailingSlash para garantir que uma barra final esteja sempre presente na request
